...
(La question vous sera de nouveau pos\195\169e lors des prochains raids. Utilisez la commande /lm config pour modifier ce r\195\169glage)]=]
L[" (Invalid link)"] = "(Lien non valide)"
L[" (Loot not registered in CT_RaidTracker; please set it manually)"] = "(L'objet n'est pas enregistr\195\169 dans CT_RaidTracker; inscrivez-le manuellement)"
...
L[" (Unable to register in HeadCount; itemID not found)"] = "(Impossible d'enregistrer dans HeadCount; le num\195\169ro d'identification de l'objet n'a pas \195\169t\195\169 trouv\195\169)"
L[" (Unable to register in HeadCount; last item not found)"] = "(Impossible d'enregistrer dans HeadCount; le dernier item n'a pas \195\169t\195\169 trouv\195\169)"
...
|cFFFF8080WARNING: Alot of settings have been hidden because the EPGPLootmaster 'ML' module has been disabled. Please enabled it from the addon configuration screen.|r]=] ] = [=[AVERTISSEMENT|cFFFF8080 : Un grand nombre de r\195\169glages sont masqu\195\169s parce que le module EPGPLootmaster 'ML' est d\195\169sactiv\195\169. Veuillez l'activer via la fen\195\170tre de configuration de l'add-on.|r
]=]
L[ [=[
Empty: use normal GP value 
50%: use 50% of normal GP value 
25: all items are worth 25 GP]=] ] = [=[Vide : utilise la valeur GP normale
50% : utiliser la moiti\195\169 de la valeur en GP
25 : tous les objets ont une valeur de 25 GP]=]
L["\"%s\" not understood. usage:"] = "\"%s\" non compris. Utilisation :"
...
L["%s received %s for disenchantment%4$s."] = "%s re\195\167oit %s pour le d\195\169senchantement%4$s."
L["%s received %s for unknown reason%4$s."] = "%s re\195\167oit %s pour raison inconnue%4$s."
L["%s rolled %s."] = "%s rand pour %s."
L["%s secs until pass"] = "%s secs avant de passer"
L["%s sent \"%s %s\"; not understood, returned usage list."] = "%s envoie \"%s %s\"; non compris. Renvoy\195\169 \195\160 la liste d'utilisation."
...
L["(Re)announce loot to candidate"] = "(R\195\169)annoncer les loots en cours"
L["** MONITOR ONLY **"] = "** SURVEILLANCE UNIQUEMENT **"
L["** MONITORING ** Only %s may distribute this item **"] = "** SURVEILLANCE ** Seul %s peut distribuer cet objet **"
L[", BoE"] = ", LqE"
L[", BoP"] = ", LqR"
L[", BoU"] = ", LqU"
L[". Please note that the candidate will receive a notice about this in whisper."] = ". Veuillez prendre note que le candidat au loot recevra un message en whisp \195\160 ce propos."
...
L["Always enable bidding"] = "Toujours activer les demandes d'offres"
...
Manual: Disable the bidding system by default and allow me to select per item (you should disable auto announce). Bidding system will be disabled when you're using the auto announcing system. You can by-pass the auto announcing system per item by alt+clicking an item on the native loot window.]=] ] = [=[Always: Les offres entrantes seront toujours disponibles quand les annonces automatiques serons utilis\195\169es.

Manuel: D\195\169sactive le syst\195\168me d'offre par d\195\169faut et m'autorise a s\195\169lectionner l'objet ( Vous devriez d\195\169sactiver les annonces automatiques ). Le syst\195\168me d'offre sera d\195\169sactiv\195\169 quand vous utilis\195\169 les annonces automatiques. Vous pouvez "by-passer" le syst\195\168me d'annonce automatique d'objet en faisant alt+click sur l'item dans la fen\195\170tre de loot d'origine ]=]
L["Amount of buttons to display:"] = "Ensemble des boutons \195\160 afficher"
L["Announce loot"] = "Annonce des loots"
L["Announce loot & request bids"] = "Annoncer les loots et demander les jets de d\195\169s"
...
L["Auto loot threshold (BoE and BoU items only)"] = "Seuil de loot automatique (LqE ou LqU uniquement)"
...
L["bank"] = "banque"
L["Bid"] = "Offre"
L["Bidding system"] = "Syst\195\168me d'offres"
L["Button 1"] = "Bouton 1"
L["Button 2"] = "Bouton 2"
L["Button 3"] = "Bouton 3"
L["Button 4"] = "Bouton 4"
...
L["Click to announce this item to all candidates and allow GP bid input"] = "Cliquer pour annoncer cet objet pour tous les candidats et autoriser les offres GP"
L["Click to ask your loot council to vote for a player for the selected item"] = "Cliquer pour demander une concertation de l'objet gagn\195\169 au joueur pour l'objet s\195\169lectionn\195\169 "
...
L["Click to vote for this candidate"] = "Cliquer pour voter pour ce candidat"
...
L["Disallow voting for self"] = "Emp\195\170cher de voter pour soi-m\195\170me"
...
L["Enable the bidding system"] = "Activer le syst\195\168me d'offres"
L["Enable the voting system"] = "Activer le syst\195\168me de vote"
...
L["Give loot and award %s GP Bid"] = "Donner l'objet et recompenser %s GP Offre"
...
L["Listen for incoming monitor updates"] = "Liste des am\195\169liorations entrantes"
...
L["Manual, disable bidding when auto announcing"] = "Manuel, d\195\169sactiver les offres quand il y a une annonce automatique"
...
L["No time left"] = [=[Pas de temps suppl\195\169mentaire
]=]
L["No timeout"] = "Pas de temps mort"
L["Noone has voted for %s"] = "Personne n'a vot\195\169 pour %s"
...
L["Old client fallback compatibility"] = "Compatibilit\195\169 des anciennes versions"
...
L["Only BoE and BoU items will be filtered. BoP items will always send a monitor message."] = "Seuls les objets LqE ou LqU sont filtr\195\169s. Les objets LqR donneront toujours lieu \195\160 un message g\195\169n\195\169ral."
L["Only listen for monitor messages from the raid for items that match this threshold or are higher. (Please keep in mind that patterns etc also match this threshold)"] = "Ne prendre en compte les messages des membres du raid que pour les objets de qualit\195\169 \195\169gale ou sup\195\169rieure au seuil (Gardez en t\195\170te que les plans et autres sont de qualit\195\169 \195\169gale au seuil)"
L["Only receive for equal or higher than"] = "Recevoir uniquement si \195\169gal ou sup\195\169rieur \195\160"
L["Only send for equal or higher than"] = "Envoyer uniquement si \195\169gal ou sup\195\169rieur"
...
L["Only send to promoted players in raid"] = "Envoyer uniquement aux joueurs assistants dans le raid"
L["Only send to specific guildranks"] = "Envoyer uniquement aux rangs de guilde sp\195\169cifiques "
L["Only send to the following guildranks:"] = "Envoyer uniquement aux rangs de guilde suivants :"
...
L["Please click this button to vote for %s for the selected item"] = "Cliquer sur ce bouton pour voter pour %s pour l'objet s\195\169lectionn\195\169"
L["Please enable the lootmaster ML module."] = "Veuillez activer le module Lootmaster ML"
L["Please enter the name of the default candidate to receive the BoE and BoU items here."] = "Merci d'entrer ici le nom du joueur par d\195\169faut pour recevoir les objets LqE et LqU"
...
L["Registered bid %d, %s for %s"] = "Offre enregistr\195\169e %d, %s pour %s"
...
L["Request votes"] = "Demande de votes"
L["Response"] = "R\195\169ponse"
L["Roll"] = "Rand"
L["Save"] = "Sauver"
L["Saved to %d, but not yet locked"] = "Mis de c\195\180t\195\169 pour %d, mais non encore bloqu\195\169"
L["Saved to %d, locked"] = "Mis de c\195\180t\195\169 pour %d, bloqu\195\169"
L["Saved to your instance"] = "Sauvegard\195\169 pour votre instance"
...
L["Send outgoing monitor updates"] = "Envoyer les mises \195\160 jour sortantes"
L["Serious error in class bitdecoder, bits %s not found. Please make sure you have the latest version installed and report if problem persists."] = "Erreur s\195\169rieuse dans la classe bitdecoder, bits %s non trouv\195\169es. Soyez sur que vous ayez la derni\195\168re version disponible install\195\169e et soumettez un rapport si le probl\195\168me persiste. "
L["Serious error in class bitencoder, class %s not found. Please make sure you have the latest version installed and report if problem persists."] = "Erreur s\195\169rieuse dans la classe bitdecoder, bits %s non trouv\195\169es. Soyez sur que vous ayez la derni\195\168re version disponible install\195\169e et soumettez un rapport si le probl\195\168me persiste. "
...
L["Sets automatic looting threshold, any BoE and BoU loot that is of lower or equal quality will get auto sent to the candidate below."] = "S\195\169lectionner le seuil de loot automatique, tous les objets LqE et LqU, de qualit\195\169 \195\169gale ou sup\195\169rieure au seuil seront envoy\195\169s au joueur s\195\169lectionn\195\169 par d\195\169faut."
...
L["The bidding system is a variation of the EPGP system where loot candidates are allowed to bid a custom GP value per item. The highest GP bid wins the loot."] = "Le syst\195\168me d'offres est une variation du syst\195\168me EPGP l\195\160 o\195\185 les candidats sont autoris\195\169s \195\160 donner une offre GP par objet. L'offre la plus \195\169lev\195\169e gagne l'objet"
...
L["The EPGP Lootmaster auto looter allows you to send specific BoU and BoE items to a predefined candidate without asking questions."] = "L'auto-loot d'EPGPLootmaster vous permet d'envoyer sp\195\169cifiquement tous les objets LqE et LqU \195\160 un joueur pr\195\169d\195\169fini sans pr\195\169avis."
...
L["The following players have voted for %s:"] = "Les joueurs suivants ont vot\195\169 pour %s :"
L["The voting system allows the master looter to request help when making a decision. While this is not something that's encouraged by the EPGP system as it will slow down the looting process a little, it will provide a guild much more flexibility. The master can request a vote per item at any time by a simple press of a button."] = "Le syst\195\168me de vote autorise le maitre du butin \195\160 demander de l'aide quand il prend une d\195\169cision. Bien que ceci ne soit pas encourag\195\169 par le syst\195\168me EPGP car cela ralentira un peu le syst\195\168me de loot, cela donnera une meilleure flexibilit\195\169 a la guilde. Le ma\195\174tre du butin peut requ\195\169rir un vote par objet \195\160 n'importe quel moment en cliquant sur le bouton de jet de d\195\169s."
L["The voting system allows the master looter to request help when making a decision. While this is not something that's encouraged by the EPGP system as it will slow down the looting process a little, it will provide a guild much more flexibility. The master looter can request a vote per item at any time by a simple press of a button."] = "Le syst\195\168me de vote autorise le ma\195\174tre du butin \195\160 demander de l'aide quand il prend une d\195\169cision. Bien que ceci ne soit pas encourag\195\169 par le syst\195\168me EPGP car cela ralentira un peu le syst\195\168me de loot, cela donnera une meilleure flexibilit\195\169 a la guilde. Le ma\195\174tre du butin peut requ\195\169rir un vote par item a n'importe quel moment en cliquant sur le bouton de jet de d\195\169s."
L["The voting system has been disabled or no votes have been requested. You can enable the voting system from the configuration panel and you can request votes by pressing the [Request Votes] button if you are the master looter"] = "Le syst\195\168me de vote a \195\169t\195\169 d\195\169sactiv\195\169 ou aucun vote n'a \195\169t\195\169 demand\195\169. Vous pouvez activer le syst\195\168me de vote depuis le panneau de configuration et vous pouvez requ\195\169rir un vote en cliquant sur le bouton [Demander un vote] si vous \195\170tes le chef de butin"
...
L["This will cause some overhead, since monitor messages will be sent one-by-one to players. Leave this disabled if you want everybody to be able to see the monitor. Disabling this option also makes the monitors respond faster."] = "Ceci causera une surcharge car le moniteur de message enverra les messages un a un aux joueurs. Laisser ceci d\195\169sactiv\195\169 si vous voulez que tout le monde puisse voir le moniteur. Laissez le d\195\169sactiv\195\169 pour que le moniteur soit plus rapide."
L["This will disallow players from voting on themselves"] = "Ceci emp\195\170chera les joueurs de voter pour eux-m\195\170mes "
...
L["Unable to unlocalize %s"] = "Impossible de ne pas localiser %s"
L["Unknown"] = "Inconnu"
L["unknown"] = "Inconnu"
...
L["Vote"] = "Voter"
L["Votes"] = true
L["Voting system"] = "Syst\195\168me de vote"
L["When should bidding be available to player?"] = "Quand les demandes d'offres doivent-elles \195\170tre propos\195\169es aux joueurs ?"
L["Whisper"] = "Wisp"
