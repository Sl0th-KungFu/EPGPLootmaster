...
local version 	    = "7.3"
local dVersion 	    = "2021-07-24T16:13:24Z"
local iVersion	    = 4
local iVersionML	  = 12
local _G            = _G
...
function LootMaster:EnterWorld()
	C_ChatInfo.RegisterAddonMessagePrefix("EPGPLootMasterC")
	C_ChatInfo.RegisterAddonMessagePrefix("EPGPLMVChk")
	C_ChatInfo.RegisterAddonMessagePrefix("EPGPLMVRsp")
	C_ChatInfo.RegisterAddonMessagePrefix("EPGPLMVHdlr")
	C_ChatInfo.RegisterAddonMessagePrefix("EPGPLootMasterML")
end
