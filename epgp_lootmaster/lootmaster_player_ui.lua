...
-- Fix for broken setBackDrops
function LootMaster:CreateFrame(frm, name, parent)
    local frame = CreateFrame(frm, name, parent or UIParent)
...
function LootMaster:InitUI()
    ...
    local frame = LootMaster:CreateFrame("Frame", "LootMasterUIFrame", UIParent)
...
function LootMaster:CreateLootSelectFrame()
    ...
    local frame = LootMaster:CreateFrame("Frame", nil, self.frame)
    --#region Setup main masterlooter frame
    frame:Show()
    ...
    local timerFrame = LootMaster:CreateFrame("Frame", nil, frame)
    ...
    local timerBorderFrame = LootMaster:CreateFrame("Frame", nil, timerFrame)
    ...
    --[[ NOTE EDITBOX ]]--
    local tbNote = LootMaster:CreateFrame("EditBox", nil, frame)
